...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pn_agregar.add(tf_universo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, 218, 30));
    ...
    private void bt_agregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_agregarMouseClicked
        try {
            personajes.add(new Personajes(tf_nombre.getText(), tf_debilidad.getText(), tf_universo.getText(), 
                    Double.parseDouble(tf_poder.getText()),Double.parseDouble(tf_fuerza.getText()),
